              ...
              <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item">
                  ...
                  <ul>
                    ...
                    <li><a href="listings2.php?category=2">상품 카테고리2</a></li>
                    <li><a href="listings3.php?category=3">상품 카테고리3</a></li>
                  </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link js-scroll-trigger" href="../test.php">글쓰기</a>
                </li>
              </ul>
            </div>
          </div>
